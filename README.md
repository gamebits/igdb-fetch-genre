...
* **Genre Insertion:** Because the spreadsheet has three or more columns, the new `Genre` column is cleanly injected immediately before the `Episode #` column, preserving the layout and content of the preceding and trailing columns.
